...
/** Frozen benchmark baseline from da2b39a (v1.1.0), never packaged in the app. Small grayscale analysis only. No color transforms are applied to the saved photograph. */
final class BaselineDocumentEdges {
